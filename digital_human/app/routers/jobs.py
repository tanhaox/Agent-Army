        ...
        try:
            while True:
                ...
                try:
                    ...
                    if data.get("type") in ("rewrite_done", "rewrite_error", "tts_done", "tts_error", "carnival_done", "carnival_error", "correct_done", "correct_error", "material_done", "material_error"):
                        break
