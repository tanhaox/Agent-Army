"""AST 硬约束检查: digital_human_video.py(瘦身) + dhv_service.py + comfyui_client.py.

检查项: 文件 ≤250 行, 函数 ≤40 行(编排 ≤65-70), 类 ≤200 行, 模块 ≤3 类,
`__init__.py` 含 `__all__`, 禁止 `from ... import *`.
用法: .venv/Scripts/python.exe scripts/_ast_check_dhv.py
"""
...
FILES = [
    ROOT / "app/routers/digital_human_video.py",
    ROOT / "app/services/dhv_service.py",
