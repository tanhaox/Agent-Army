"""AST 硬约束检查: voices.py(瘦身) + voice_service.py.

检查项: 文件 ≤250 行, 函数 ≤40 行(编排 ≤65-70), 类 ≤200 行, 模块 ≤3 类,
`__init__.py` 含 `__all__`, 禁止 `from ... import *`.
用法: .venv/Scripts/python.exe scripts/_ast_check_voices.py
"""
...
FILES = [
    ROOT / "app/routers/voices.py",
    ROOT / "app/services/voice_service.py",
]
FILE_LIMIT = 250
FUNC_LIMIT = 40
ORCH_LIMIT = 70
