...
> **版本**: v7.0.33 | **日期**: 2026-06-19 | **更新**: v2 Trainer 按 regime 训练改造 + 22 字段回填 + DeepSeek/ResultPage 字段透传
...
| **[DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md)** | ~620 | ✅ 完整 | 开发施工手册 (v2.5, 含 22 字段 + v2 trainer regime 训练) |
