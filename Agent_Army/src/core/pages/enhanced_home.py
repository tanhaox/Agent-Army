...
def render_enhanced_home():
    ...
    create_gradient_banner(
        title="🎖️ Agent Army",
        subtitle="股票价值投资AI军团 - v2.0 8部门制精简架构"
    )
    ...
    # 欢迎信息
    st.markdown("### 🎉 欢迎使用 Agent Army v2.0")
    st.markdown("**AI驱动的价值投资分析系统（8部门制精简版）**")
    st.markdown("""
    - • 24个专业AI Agent（精简43%）
    - • 8大部门覆盖投资全流程
    - • 完整的分析+决策+验证闭环
    ...
    # ========== v2.0 核心成果 ==========
    with st.expander("📈 查看v2.0核心成果详情", expanded=False):
        st.markdown("""
        #### ✅ 已完成的性能优化
    ...
    with col2:
        st.success("🎯 **当前版本**: v2.0 - 8部门制精简架构")
        st.caption("✅ 24个Agent精简完成 | 100%测试通过 | 生产就绪")
...
└── 📊 8大业务部门 (6/24个AI)
    ...
    # ========== 当前成果 ==========
    st.markdown("### ✅ v2.0 完成成果")
    st.success("""
    **v2.0: 8部门制精简架构完成**

    - ✅ 完成24个核心Agent部署（精简43%，从47个优化至24个）
    - ✅ 实现8大部门覆盖投资全流程
    - ✅ 集成Commander质量审核机制
