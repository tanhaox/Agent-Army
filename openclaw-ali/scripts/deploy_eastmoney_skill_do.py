#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""部署eastmoney-data-claude Skill到DigitalOcean服务器"""
import paramiko
import sys
...
LOCAL_SKILL = Path('C:/AI-Agent-Local/openclaw-ali/skills/eastmoney-data-claude')
REMOTE_DIR = '/root/.openclaw/workspace/skills/eastmoney-data-claude'

print("=" * 70)
print("  部署 A股数据补充 Skill 到 DigitalOcean")
print("=" * 70)
print()
...
print()
print("📋 Skill信息:")
print(f"  名称: eastmoney-data-claude")
